...
1.  Create a [new account](https://newrelic.com/signup) on New Relic and verify your email.\
    ...
    <figure><img src="../../.gitbook/assets/image (40).png" alt=""><figcaption><p>New Relic: Account Creation</p></figcaption></figure>

    \


    <figure><img src="../../.gitbook/assets/image (16).png" alt=""><figcaption><p>New Relic Home Page </p></figcaption></figure>
2.  Click on your **Profile** and navigate to "**API keys**".\


    <figure><img src="../../.gitbook/assets/image (65).png" alt=""><figcaption><p>API Keys</p></figcaption></figure>
...
5.  Confirm Licence has been created\
    ...
    <figure><img src="../../.gitbook/assets/image (52).png" alt=""><figcaption><p>Licence Created</p></figcaption></figure>
...
1.  Navigate to the Dashboard and click on "**Import Dashboard**".\
    ...
    <figure><img src="../../.gitbook/assets/image (17).png" alt=""><figcaption><p>Import Dashboard</p></figcaption></figure>
2.  Copy and paste the edited contents of the "`cicd-dashboard.json"` file in the previous section with the updated "Account id".\


    <figure><img src="../../.gitbook/assets/image (58).png" alt=""><figcaption><p>JSON Import Dashboard</p></figcaption></figure>
