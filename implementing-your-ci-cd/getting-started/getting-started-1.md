...
1.  Create Public Groups **(Setup > Users > Public Groups)**
    ...
    * Developers (developers who are allowed to fetch scratch orgs from pool)\
    ...
    <figure><img src="../../.gitbook/assets/image (49).png" alt=""><figcaption><p>Public Group: Developers</p></figcaption></figure>
...
3.  Assign Users to Public Groups **(Setup > Security > Sharing Settings)**
    ...
    * Developers
    ...
    <figure><img src="../../.gitbook/assets/image (60).png" alt=""><figcaption><p>Public Group: User Assignment</p></figcaption></figure>
