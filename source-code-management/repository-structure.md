...
5. **src-env-specific:** An [aliasified package ](../sfpowerscripts/types-of-packaging/source-packages.md)which carries metadata for each particular stage (environment) of your path to production. Some examples include named credentials, remote site settings, web links, custom metadata, custom settings, etc.
